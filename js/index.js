...
$(".animate0").mouseenter(function() {
	...
	$(".pList1").css("display", "flex");
	//	setTimeout(function(){
	timer1 = setInterval(function() {
			$(".pList1 a").eq(num).animate({
				"opacity": "0.7",
				"filter":"alpha(opacity=70)",
				"margin-left": "-50px"
			}, 400);
			num++;
			if(num > $(".pList1 a").length) {
				num = 0;
				clearInterval(timer1);
			}
		}, 100)
...
$(".animate1").mouseenter(function() {
	...
	$(".pList2").css("display", "flex");
	//	setTimeout(function(){
	timer1 = setInterval(function() {
			$(".pList2 a").eq(num).animate({
				"opacity": "0.7",
				"filter":"alpha(opacity=70)",
				"margin-left": "-50px"
			}, 400);
			num++;
			if(num > $(".pList2 a").length) {
				num = 0;
				clearInterval(timer1);
			}
		}, 100)
...
$(".animate2").mouseenter(function() {
	...
	$(".pList3").css("display", "flex");
	//	setTimeout(function(){
	timer1 = setInterval(function() {
			$(".pList3 a").eq(num).animate({
				"opacity": "0.7",
				"filter":"alpha(opacity=70)",
				"margin-left": "-50px"
			}, 400);
			num++;
			if(num > $(".pList3 a").length) {
				num = 0;
				clearInterval(timer1);
			}
		}, 100)
